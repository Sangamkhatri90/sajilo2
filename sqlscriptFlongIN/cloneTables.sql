...
CREATE TABLE [dbo].[tbSystemSettings] (
    ...
    [LockEdit] BIT,
    [LockDelete] BIT,
    [LockDateFrom] DATETIME,
    [LockDateTo] DATETIME,
    [DefaultVoucherAction] NVARCHAR(100),
    [ShowTACode] BIT,
    [NCB] BIT,
    [NBB] BIT,
    [MinCB] BIT,
    [MinCBAmount] DECIMAL(18,2),
    [MaxCB] BIT,
    [MaxCBAmount] DECIMAL(18,2),
    [MaxPBC] BIT,
    [MaxPBCAmount] DECIMAL(18,2),
    [VoucherOnlinePrint] BIT,
    [InterestTaxRate] DECIMAL(18,2),
    [MinSB] DECIMAL(18,2),
    [MaxSB] DECIMAL(18,2),
    [BookedOrder] BIT,
    [RecorderLevel] INT,
    [AutoBackup] BIT,
    [AutoBackupDayDiff] INT,
    [BackupPath] NVARCHAR(500),
    [AutoBackupDate] DATETIME,
    [RemindBackup] BIT,
    [RemindBackupDayDiff] INT,
    [RemindDate] DATETIME,
    [BackupDate] DATETIME,
    ...
    [CounterBillDesign] NVARCHAR(100),
    [SLWithMultipleGL] BIT,
    [Incentive] BIT,
    [InterestRound] INT,
    [InterestTaxDecimal] INT,
    [DebitStudentFromBill] BIT,
    [StudentBillDesign] NVARCHAR(100),
    [StudentReceiptDesign] NVARCHAR(100),
    [DocClassCaption] NVARCHAR(255),
    [GodownSystem] BIT,
    [ProfitCaption] NVARCHAR(255),
    [LossCaption] NVARCHAR(255),
    [Trading] BIT,
    [ConfirmSaving] BIT,
    [Nepali] BIT,
    [UseTACodeBilling] BIT,
    [ShowAllProductInHospitalBiilling] BIT,
    [ReportFooter] NVARCHAR(MAX),
    [SourceofFundMaxLimit] DECIMAL(18,2),
    [GLIDShareAc] INT,
    [SharePrice] DECIMAL(18,2),
    [InterestPostingVoucher] NVARCHAR(100),
    [ShareTransactionVoucher] NVARCHAR(100),
    [StatementFormat] NVARCHAR(100),
    [ShowShareAcInFrontPanel] BIT,
    [VoucherFooter] NVARCHAR(MAX),
    [DocClassCaptionNepali] NVARCHAR(255),
    [ShowLastDate] BIT,
    [LastBackupLocation] NVARCHAR(500),
    [SubGroupSystem] BIT,
    [DayClosing] BIT,
    [FastDayClosing] BIT,
    [GLIDIncomeTaxAc] INT,
    [IncomeTaxPercent] DECIMAL(18,2),
    [DividendTaxRate] DECIMAL(18,2),
    [GLIDDividendTaxAc] INT,
    [ShowStartupAlertForMaturedAccounts] BIT,
    [ShowStartupAlertForInstallment] BIT,
    [ShowStartupAlertForFixedMatured] BIT,
    [GLIDTrialDifference] INT,
    [EmailAddress] NVARCHAR(255),
    [EmailPassword] NVARCHAR(255),
    [MailSendingComputer] NVARCHAR(255),
    [EmailAlertAmount] DECIMAL(18,2),
    [ItemCaption] NVARCHAR(255),
    [AliasCaption] NVARCHAR(255),
    [CCCaption] NVARCHAR(255),
    [AltAliasCaption] NVARCHAR(255),
    [AllowDuplicateAlias] BIT,
    [NegativeStock] BIT,
    [ProductWiseAc] BIT,
    [Sales] INT,
    [SalesReturn] INT,
    ...
    [ChequeLock] BIT,
    [SMSService] BIT,
    [WeborModem] NVARCHAR(50),
    [WebSMSMessageURL] NVARCHAR(MAX),
    [WebSMSSuccessMessage] NVARCHAR(500),
    [WebSMSBalanceQueryURL] NVARCHAR(MAX),
    [AlertonWithdrawAmount] DECIMAL(18,2),
    [AlertonDepositAmount] DECIMAL(18,2),
    [MessageInstallment] NVARCHAR(MAX),
    [MessageMaturityLoan] NVARCHAR(MAX),
    [MessageMaturityDeposit] NVARCHAR(MAX),
    [MessageDeposit] NVARCHAR(MAX),
    [MessageWithdraw] NVARCHAR(MAX),
    [TabCollection] BIT,
    [MBankVoucher] NVARCHAR(100),
    [GLIDMBank] INT,
    [SCTVoucher] NVARCHAR(100),
    [GLIDSCT] INT,
    [NepaliSMS] BIT,
    [SMSExEFile] NVARCHAR(500),
    [GLIDDemandChargeUnit] INT,
    [GLIDServiceChargeUnit] INT,
    [GLIDTarrifIncomeUnit] INT,
    [GLIDContraforReceivableTarrifUnit] INT,
    [UnitBillingVoucher] NVARCHAR(100),
    [UnitCashReceiptVoucher] NVARCHAR(100),
    [VoucherApprovedByName] NVARCHAR(255),
    [VoucherApprovedByDesignation] NVARCHAR(255),
    [VoucherCheckedByName] NVARCHAR(255),
    [VoucherCheckedByDesignation] NVARCHAR(255),
    [VoucherVerifiedByName] NVARCHAR(255),
    [VoucherVerifiedByDesignation] NVARCHAR(255),
    [MessageLongTimeNoTran] NVARCHAR(MAX),
    [GLIDSMSIncome] INT,
    [SMSCharge] DECIMAL(18,2),
    [SMSDaysAfterLastTranDate] INT,
    [SuspendPenalty] BIT,
    [GLIDPatronageRefundTaxAc] INT,
    [PatronageRefund] BIT,
    [AutoCalculateInterestonTransactionPanel] BIT,
    [AutoDistributeAmountinTransactionPanel] BIT,
    [AskforInstallmentMonth] BIT,
    [DayStart] TIME,
    [DayStartAfter] TIME,
    [DayCloseByStartedUser] BIT,
    [InsertAllontbJournalDetails] BIT,
    [ChequePrinting] BIT,
    [DifferentTaxationforPalika] BIT,
    [LadderInterestonLoan] BIT,
    [MasterDbName] NVARCHAR(255),
    [SMSFromJournal] BIT,
    [GLIDAILoanContra] INT,
    [GLIDAILoanReceivable] INT,
    [GLIDAISavingExpense] INT,
    [GLIDAISavingPayable] INT
);
